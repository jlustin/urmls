...
public class StaffController extends Controller {
     ...
     * box1 and box2 are radio buttons selected by user
     * box1 == Research Assistant
     * box2 == Research Associate
     */
    public void editStaffmemberRecord(int index, int id, String desiredName, boolean box1, boolean box2, double weeklySalary) {
        URLMS urlms = URLMSApplication.getURLMS();
        Lab aLab = urlms.getLab(0);
     ...
     * and staff Roles defined by booleans for checkedbox/radio buttons
     * box1==staff assistant
