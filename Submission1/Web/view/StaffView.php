			      		...
			      		<form action="StaffRequest.php" method="get">
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<small id="nameHelp" class="form-text text-muted">Enter the name of the new staff member.</small>
								</div>
								<div class="col-sm-6">
									...
									<small id="nameHelp" class="form-text text-muted">Enter the weekly salary of the new staff member.</small>
								</div>
							</div>
							<br>
			      		...
			      		<form action="StaffRequest.php" method="get">
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<small id="nameHelp" class="form-text text-muted">Enter the name of the staff member to be removed.</small>
								</div>
								<div class="col-sm-6">
									<label for="oldStaffID">ID</label>
									<input type="text" class="form-control" name="oldstaffid" id="oldStaffID" placeholder="Enter staff ID"/>
									<small id="nameHelp" class="form-text text-muted">Enter the ID of the staff member to be removed.</small>
				 				</div>
				 			</div>
				 			<br>
			        ...
			        <form action="StaffRequest.php" method="get">
						...
						<div class="row">
							<div class="col-sm-6">
								...
								<small id="nameHelp" class="form-text text-muted">Enter the name of the staff member to be viewed.</small>
							</div>
							<div class="col-sm-6">
								<label for="staffID">ID</label>
								<input type="text" class="form-control" name="staffid" id="staffID" placeholder="Enter staff ID"/>
								<small id="nameHelp" class="form-text text-muted">Enter the ID of the staff member to be viewed.</small>
							</div>
						</div>
						<br>
