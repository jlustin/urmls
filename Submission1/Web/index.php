		...
		<div class="row">
			<div class="col-sm-4">
				<div class="card home-page-elem" style="width: 20rem;">
					<a href="View/StaffView.php"> <img class="card-img-top"
			...
			<div class="col-sm-4">
				<div class="card home-page-elem" style="width: 20rem;">
					<a href="View/InventoryView.php"> <img class="card-img-top"
			...
			<div class="col-sm-4">
				<div class="card home-page-elem" style="width: 20rem;">
					<a href="View/FundingView.php"> <img class="card-img-top"
